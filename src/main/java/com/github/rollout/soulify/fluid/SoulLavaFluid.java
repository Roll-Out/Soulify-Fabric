package com.github.rollout.soulify.fluid;
...
import static com.github.rollout.soulify.registry.SoulifyFluids.*;

public abstract class SoulLavaFluid extends FlowableFluid {

    public SoulLavaFluid() {
    }

    public Fluid getFlowing() {
        return FLOWING_SOUL_LAVA;
    }

    public Fluid getStill() {
        return STILL_SOUL_LAVA;
    }

    public Item getBucketItem() {
        return SOUL_LAVA_BUCKET;
    }
    ...
    public void randomDisplayTick(World world, BlockPos pos, FluidState state, Random random) {
        ...
        if (world.getBlockState(blockPos).isAir() && !world.getBlockState(blockPos).isOpaqueFullCube(world, blockPos)) {
            if (random.nextInt(100) == 0) {
                ...
                //TODO: change particle type here
    ...
    public BlockState toBlockState(FluidState state) {
        return SOUL_LAVA.getDefaultState().with(Properties.LEVEL_15, method_15741(state));
    }
